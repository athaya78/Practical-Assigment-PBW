                ...
                <div class="col-lg-8 col-md-12">
                  ...
                  <form class="form-container" action="add_proses.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-2">
                      ...
                      <select class="form-select" name="kelas" id="jurusan" aria-label="Default select example">
                        <option disabled selected>Pilih Jurusan</option>
                        <option value="Kelas Bernyanyi">Kelas Bernyanyi</option>
                        <option value="Kelas Menari">Kelas Menari</option>
                        <option value="Kelas Berhitung">Kelas Berhitung</option>
                        <option value="Kelas Beladiri">Kelas Beladiri</option>
                      </select> 
                    </div>
                    <div class="mb-2">
